...
formatted_cpa = pd.read_csv(os.path.join(input_directory, 'renewablesAU_case' + str (case) + '.csv'), index_col=False)
...
#Rver = '_offSupply'
#'_offSupply_v12_noSinkPopFilter_proRated_bulk330_proximityBased_load_4bdpaper_case'
...
capacity_all.to_csv(os.path.join(output_directory, 'capacity_constraints_case' + str(case) + '.csv'), index=False)
tx_cost_all.to_csv(os.path.join(output_directory, 'tx_cost_case' + str(case) + '.csv'), index=False)
capex_all.to_csv(os.path.join(output_directory, 'capex_cost_case' + str(case) + '.csv'), index=False)
depth_all.to_csv(os.path.join(output_directory, 'osw_depth_case' + str(case) + '.csv'), index=False)
capacity_factors_all.to_csv(os.path.join(output_directory, 'capacity_factors_case' + str(case) + '.csv'), index=False)
resource_df_all.to_csv(os.path.join(output_directory, 'binned_resource_df_case' + str(case) + '.csv'), index=False)
